...
def everything_for_your_cat(cats_data):
    """
    Функция формирует список данных о котиках и владельцах таким образом,
    чтобы для каждого владельца данные о всех его животных отображались в одной строке,
    на новой строке следующий покупатель и все его питомцы и т.д.
    :param cats_data: список кортежей с данными о котиках, их возрасте и владельце.
    :return: строка, содержащая структурированные данные по владельцам и их котикам.
    """
    our_str = ''
    dict_str = dict()
    if cats_data:
