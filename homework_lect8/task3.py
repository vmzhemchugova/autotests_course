...
def segment(coord1: tuple, coord2: tuple):
    """
    Функция принимает на вход два кортежа с координатами точек (x1, y1), (x2, y2).
    Происходит проверка полученных данных на корректность:
    Если поймали исключение Exception - возвращает текст исключения задом наперед;
    Если данные корректны - возвращает сумму всех координат.
    :param coord1: кортеж с координатами первой точки,
    :param coord2: кортеж с координатами второй точки,
    :return: сумма координат или перевернутый текст исключения
    """
    x1, y1 = coord1
    x2, y2 = coord2
    try:
